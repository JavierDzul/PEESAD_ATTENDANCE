        ...
        <div className="accordion w-75" id="accordionExample">
            {classes &&
                classes
                    .filter(
                        (cls: Class) =>
                            username === (cls.teacher?.user?.name
                                ? cls.teacher.user.name + cls.teacher.user.lastName + cls.teacher.user.motherLastName
                                : "") ||
                            username === (cls.tutor?.user?.name
                                ? cls.tutor.user.name + cls.tutor.user.lastName + cls.tutor.user.motherLastName
                                : "")
                    )
                    .map((cls: Class) => (
